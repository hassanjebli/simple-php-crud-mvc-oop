...
<div class="max-w-3xl mx-auto">
    ...
    <form action="index.php?action=update" method="POST" class="needs-validation" novalidate>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            ...
            <div class="bg-gray-50 px-6 py-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <h2 class="text-sm font-semibold text-gray-900">User ID: #<?php echo $user['id']; ?></h2>
                        <p class="text-sm text-gray-500">Editing user profile details</p>
                    </div>
                </div>
            </div>
